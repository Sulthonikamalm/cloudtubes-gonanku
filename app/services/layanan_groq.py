...
_SISTEM_INTENT = (
    ...
    "- Ekstrak kata kunci yang PALING RELEVAN dari pertanyaan.\n"
    "- Sertakan sinonim dan variasi kata yang mungkin ada di judul/deskripsi file.\n"
    "- Jika user bilang 'foto kucing', kata_kunci = [\"foto\", \"kucing\"].\n"
    "- Jika user bilang 'dokumen skripsi bab 3', kata_kunci = "
    "  [\"skripsi\", \"bab 3\", \"bab\"].\n"
    "- Jika user bilang 'resi shopee', kata_kunci = [\"resi\", \"shopee\"].\n"
    "- JANGAN masukkan kata-kata umum seperti 'yang', 'ada', 'gak', 'cari'.\n"
