"""Logika bisnis berkas: upload (single & bulk), baca, edit metadata, regenerasi AI.
...
Logika sampah (soft delete, restore, hapus permanen, kosongkan) dipisah
ke `layanan_berkas_sampah`. Re-export di bawah agar call site existing
`layanan_berkas.hapus_lunak_berkas(...)` dst tetap jalan tanpa modifikasi
di routes. Modul tetap fokus dan ≤400 baris.
"""
...
# Re-export fungsi sampah supaya `layanan_berkas.hapus_lunak_berkas(...)` di
# routes tetap menemukan fungsinya tanpa harus ubah import di sana.
from app.services.layanan_berkas_sampah import (  # noqa: F401
    ambil_berkas_terhapus,
    hapus_lunak_berkas,
    pulihkan_berkas,
    hapus_permanen_berkas,
    kosongkan_sampah,
)
...
# ============================================================
# UPDATE METADATA + REGENERASI AI
# (soft delete, restore, hapus permanen dipisah ke layanan_berkas_sampah)
# ============================================================
